...
const SEED_IDS = ['hier_airflow_dags', 'hier_schema_audit', 'hier_excel_mapping']
...
const SEEDS: Widget[] = [
  {
    ...
    sql: '', data: [],
    layout: { i: 'hier_airflow_dags', x: 0, y: 0, w: 12, h: 9, minH: 6 },
  },
  {
    ...
    stacked: false, dual_axis: false, ai_description: '',
    sql: '', data: [],
    layout: { i: 'hier_schema_audit', x: 0, y: 9, w: 12, h: 12, minH: 8 },
  },
  {
    ...
    stacked: false, dual_axis: false, ai_description: '',
    sql: '', data: [],
    layout: { i: 'hier_excel_mapping', x: 0, y: 21, w: 12, h: 10, minH: 6 },
  },
]
