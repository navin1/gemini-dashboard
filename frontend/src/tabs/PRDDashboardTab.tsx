...
const SEED_IDS = ['vendor_airflow_dags', 'vendor_schema_audit', 'vendor_excel_mapping']
...
const SEEDS: Widget[] = [
  {
    ...
    sql: '', data: [],
    layout: { i: 'vendor_airflow_dags', x: 0, y: 0, w: 12, h: 9, minH: 6 },
  },
  {
    ...
    stacked: false, dual_axis: false, ai_description: '',
    sql: '', data: [],
    layout: { i: 'vendor_schema_audit', x: 0, y: 9, w: 12, h: 12, minH: 8 },
  },
  {
    ...
    stacked: false, dual_axis: false, ai_description: '',
    sql: '', data: [],
    layout: { i: 'vendor_excel_mapping', x: 0, y: 21, w: 12, h: 10, minH: 6 },
  },
]
